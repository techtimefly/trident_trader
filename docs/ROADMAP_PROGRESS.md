...
## Final
- [x] R.1 Full code review of the whole application; score each feature from the perspective of a real day trader; write the result to `docs/DAY_TRADER_REVIEW.md`.
